...
MAX_SEQ_LEN_LLM = 120           # Do not edit it.
    ...
    for x, input_audio in enumerate(task_queue, 1):
        ...
        if 'Translate' not in task:
            ...
            if FIRST_RUN:
                ...
                if any(tag in model_llm for tag in ('1.8B', '2B', '3B', '4B')):
                ...
                save_id_llm = np.zeros(MAX_TOKENS_PER_CHUNK, dtype=np.int32)
